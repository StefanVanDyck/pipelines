...
public class ContinentKeyValueStore implements KeyValueStore<LatLng, GeocodeResponse> {
  ...
  public GeocodeResponse get(LatLng latLng) {
    return new GeocodeResponse(service.lookupContinent(latLng.getLatitude(), latLng.getLongitude()));
  }
}
