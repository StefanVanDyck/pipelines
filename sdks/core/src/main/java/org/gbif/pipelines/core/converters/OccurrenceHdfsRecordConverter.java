...
public class OccurrenceHdfsRecordConverter {
  ...
  private void mapHumboldtRecord(OccurrenceHdfsRecord occurrenceHdfsRecord) {
    ...
    // ponytail: ext_humboldt column was removed from the occurrence HDFS table in
    // occurrence-hdfs-table 1.1.26 (moved to the event table), so the humboldt JSON
    // view mapping is no longer written to the occurrence HDFS record
